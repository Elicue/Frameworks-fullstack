      ...
      <div class="flex flex-row w-full rounded-2xl border border-gray-200 gap-12 bg-white p-4">
        <div class="flex flex-col w-full justify-center">
          <div class="flex flex-row  mb-6 justify-between w-full">
            <h1 class="list-none text-3xl font-bold"> Add a playlist </h1>
          ...
          <div>
            <form @submit.prevent="submit" class="w-full flex flex-col gap-4">
              ...
              <input type="submit" class="w-fit px-6 mt-6 py-2 rounded-md font-bold transition-all duration-500 text-white shadow-[0px_0px_34px_0px_rgba(0,0,0,0.08)] hover:shadow-[0px_0px_34px_0px_rgba(0,0,0,0.1)] hover:scale-[1.01]" value="Submit your playlist" :class="[form.processing ? 'bg-gray-500' : ' bg-violet-500 hover:bg-violet-600 active:bg-violet-700']" :disabled="form.processing">
