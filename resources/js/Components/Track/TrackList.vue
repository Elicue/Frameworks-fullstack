<template>
  <div class="grid grid-cols-2 gap-5">
      <input v-model="filter" type="search" class="shadow border rounded py-2 px-3 text-gray-700 appearance-none leading-tight focus:outline-none focus:shadow-outline mb-5">
